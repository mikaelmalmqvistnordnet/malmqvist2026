...
export const PageWrapper: React.FC<PropsWithChildren> = ({ children }) => {
  return (
    <div className="w-full h-full flex justify-center overflow-x-hidden overflow-y-auto relative min-h-[100vh] pb-14">
      <div className="absolute left-0 top-0 rotate-180 justify-between w-full overflow-hidden z-10 opacity-70 md:opacity-100 hidden md:inline-block">
        <img src={blommor2} width="400" alt="" className="-ml-30" />
      </div>
      <div className="absolute w-full overflow-hidden z-10 opacity-70 md:opacity-100 hidden md:inline-flex">
        <img src={blommor1} width="400" alt="" className="rotate-180" />
      </div>
